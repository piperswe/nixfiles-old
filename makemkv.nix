...
mkDerivation {
  ...
  makeMkvItem = makeDesktopItem {
    name = "MakeMKV";
    exec = "makemkv";
    comment = "MakeMKV ${version}";
    desktopName = "MakeMKV";
    genericName = "Optical Disc Ripper";
    categories = "AudioVideo";
    icon = "${src_oss}/makemkv-oss-${version}/makemkvgui/share/icons/256x256/makemkv.png";
  };
  ...
  installPhase = ''
    ...
    wrapProgram $out/bin/makemkv --prefix PATH : ${lib.makeBinPath [ jdk ]}
